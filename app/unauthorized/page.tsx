    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <Card className="w-full max-w-md bg-card text-card-foreground">
        <CardHeader className="flex flex-col items-center text-center pb-2">
          <div className="rounded-full bg-destructive/10 p-3 sm:p-4 text-destructive mb-4 animate-bounce">
        ...
        <CardFooter className="flex justify-center pt-6">
          <Link
            ...
            className={buttonVariants({
              variant: "default",
              className: "w-full bg-destructive hover:bg-destructive/90 text-primary-foreground font-medium text-center py-2 rounded-lg"
            })}
          >
            Return to Login
          </Link>
