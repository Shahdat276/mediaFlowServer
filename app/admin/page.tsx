        ...
        <main className="flex-1 p-6 md:p-10 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-border mb-8">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="rounded-full bg-amber-500/10 border border-amber-500/20 px-2.5 py-0.5 text-xs text-amber-600 dark:text-amber-400 font-semibold">
                  System Console
                </span>
              </div>
          ...
          <div className="grid gap-6 md:grid-cols-3 mb-8">
            <Card className="border-border bg-card text-card-foreground shadow-sm">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">{dbUsers.length || "Loading..."}</div>
            ...
            <Card className="border-border bg-card text-card-foreground shadow-sm">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">Better Auth</div>
            ...
            <Card className="border-border bg-card text-card-foreground shadow-sm">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">Root Admin</div>
          ...
          <Card className="border-border bg-card text-card-foreground shadow-sm mb-8">
            <CardHeader>
                    ...
                    <tbody>
                      {dbUsers.map((user) => (
                        <tr key={user.id} className="border-b border-border hover:bg-accent/50 text-foreground">
                          <td className="py-3.5 pl-2 font-medium text-foreground">{user.name}</td>
                          ...
                          <td className="py-3.5 font-mono text-xs text-muted-foreground truncate max-w-[150px]">
                            {user.id}
                          </td>
                        </tr>
                      ))}
          ...
          <Card className="border-border bg-card text-card-foreground shadow-sm">
            ...
            <CardContent className="bg-muted rounded-lg border border-border p-4 font-mono text-xs text-muted-foreground space-y-1.5 shadow-inner">
              <p className="text-muted-foreground/60">[2026-07-06T10:55:00] PROXY: Intercepted route request to /admin</p>
