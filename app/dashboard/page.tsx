          ...
          <div className="mx-auto max-w-7xl">
              ...
              {session?.user?.role === "admin" && (
                <a
                  ...
                  className={buttonVariants({
                    variant: "default",
                    className: "bg-amber-600 hover:bg-amber-500 text-primary-foreground font-medium gap-1.5 py-2 px-3 rounded-lg"
                  })}
                >
            ...
            <div className="grid gap-6 md:grid-cols-3 mb-8">
              <Card className="border-border bg-card text-card-foreground shadow-sm">
                ...
                <CardContent>
                  <div className="text-2xl font-bold capitalize text-foreground">{session?.user?.role || "user"}</div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="border-border bg-card text-card-foreground shadow-sm">
                ...
                <CardContent className="space-y-3.5 text-sm">
                  ...
                  <div className="flex justify-between py-1 border-b border-border">
                    ...
                    <span className="text-muted-foreground font-mono text-xs truncate max-w-[200px]">{session?.user?.id}</span>
                  </div>
              ...
              <Card className="border-border bg-card text-card-foreground shadow-sm flex flex-col justify-between">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg font-bold text-foreground mt-3">Admin Access Verification</CardTitle>
